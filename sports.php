...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["delete_record"])) {
    ...
    foreach ($selected_records as $sportsid_to_delete) {
        
        $sql = "DELETE FROM sports WHERE sportsid = '$sportsid_to_delete'";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td><input type='checkbox' name='selected_records[]' value='" . $row['sportsid'] . "'></td>";
    ...
    echo "<p>No records found in sports</p>";
}
